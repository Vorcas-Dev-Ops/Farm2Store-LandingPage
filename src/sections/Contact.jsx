...
const Contact = () => {
    ...
    const validateForm = () => {
        ...
        // Name validation - supports international characters and common name formats
        ...
        // Phone validation - better support for Indian and international formats
        if (!formData.phone.trim()) {
            newErrors.phone = 'Phone number is required';
        } else {
            const cleanPhone = formData.phone.trim().replace(/[\s-()]/g, '');
            // Support +91, +1, and other country codes, and plain numbers
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const apiUrl = import.meta.env.VITE_API_URL || 'http://localhost/Backend/process_quote.php';
