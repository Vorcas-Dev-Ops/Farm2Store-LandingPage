...
import { RiLeafLine, RiGooglePlayFill, RiUser3Fill, RiArrowDownSLine, RiCheckDoubleLine, RiVerifiedBadgeLine } from 'react-icons/ri';
...
// Stats to display
const STATS = [
    { value: '2K+', label: 'Farmers Connected' },
    { value: '15K+', label: 'Tons Shipped' },
